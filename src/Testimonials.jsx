    ...
    <main className="lg:px-20 md:px-10 px-5 lg:py-20 py-14">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <div className="flex flex-col gap-6 testimonial">
          <div className="bg-gray-100 px-5 py-6 rounded-lg">
            <p className="text-sm leading-relaxed">
              “Finding our dream home felt impossible at first. We searched for
              months without success, feeling overwhelmed by the options and
              complexities. Then, we discovered this platform, and everything
              changed. The process was seamless, from browsing the listings to
              scheduling viewings and finalizing the paperwork.”
            </p>
          ...
          <div className="bg-gray-100 px-5 py-6 rounded-lg">
            <p className="text-sm leading-relaxed">
              “As a first-time buyer, I was nervous about navigating the entire
              process. From understanding the market to finding the right home,
              everything felt overwhelming. However, the dedicated agents went
              above and beyond to guide me at every step. They patiently
              answered all my questions, provided expert advice, and ensured I
              felt confident in my decisions.”
            </p>
            <div className="flex justify-between items-center pt-10 text-sm">
        ...
        <div className="flex flex-col gap-6 testimonial">
          ...
          <div className="bg-gray-100 px-5 py-6 rounded-lg">
            <p className="text-sm leading-relaxed">
              “The website is so intuitive and made renting a home in a new city
              stress-free. I found the perfect place within days.”
            </p>
            <div className="flex justify-between items-center pt-10 text-sm">
        ...
        <div className="flex flex-col gap-6 testimonial">
          ...
          <div className="bg-gray-100 px-5 py-6 rounded-lg">
            <p className="text-sm leading-relaxed">
              ...
              unsure about the price or worried about hidden issues. That’s when
              I decided to work with this platform, and it was a game-changer.
              Their detailed property insights and expert advice made a huge
              difference.”
            </p>
            <div className="flex justify-between items-center pt-10 text-sm">
