...
const Faq = () => {
  ...
  return (
    <main className="lg:px-20 md:px-10 px-5 lg:py-20 py-14 flex justify-center">
      <section className="flex lg:flex-row flex-col max-w-7xl w-full">
        <div className="w-full lg:pb-20 pb-16 faq-container">
        ...
        <section className="w-full">
          {faqs.map((questions) => (
            <div
              ...
              className={`border-t border-t-gray-300 py-6 questions cursor-pointer ${
